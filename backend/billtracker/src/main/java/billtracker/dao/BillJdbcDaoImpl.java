...
public class BillJdbcDaoImpl implements BillDao {
	...
	private void init() {
		...
		private void insertInitBills() {
			...
			Date d1 = Date.valueOf("2019-05-02"); Date d2 = Date.valueOf("2019-05-21"); Date d3 = Date.valueOf("2019-04-15"); 
			Date d4 = Date.valueOf("2019-05-15"); Date d5 = Date.valueOf("2018-10-20"); Date d6 = Date.valueOf("2018-11-20");
			Date d7 = Date.valueOf("2018-05-03"); Date d8 = Date.valueOf("2018-05-30"); Date d9 = Date.valueOf("2019-03-06");
			Date d10 = Date.valueOf("2019-04-06"); Date d11 = Date.valueOf("2019-02-19"); Date d12 = Date.valueOf("2019-03-19");
			Date d13 = Date.valueOf("2019-02-10"); Date d14 = Date.valueOf("2018-03-10"); Date d15 = Date.valueOf("2018-06-01");
			Date d16 = Date.valueOf("2018-07-01"); Date d17 = Date.valueOf("2019-01-06"); Date d18 = Date.valueOf("2019-02-06");
